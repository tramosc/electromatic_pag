...
<div class="container">
    ...
    <h1 class="align:center">Crear un nuevo Pozo</h1>
        <div class="card" style="width: 70rem;">
        <div class="card-body">
        <form action="{{ url('/pozos') }}" method="POST" class="row g-3" enctype="multipart/form-data">
        {{ csrf_field() }}
            <div class="col-md-6">
                <label for="titulo_pozo" class="form-label">Titulo del Pozo</label>
                <input type="text" class="form-control" name="titulo_pozo" id="titulo_pozo" required>
            </div>
            <div class="col-12">
                <label for="descripcion_pozo" class="form-label">Descripcion Repuesto</label>
                <input type="text" class="form-control" name="descripcion_pozo" id="descripcion_pozo" required>
            </div>
            <div class="col-2">
